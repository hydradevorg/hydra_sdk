...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib" TYPE STATIC_LIBRARY FILES "/volumes/BIGCODE/hydra_sdk/build_wasm/hydra_address/libhydra_address.a")
endif()
...
if(CMAKE_INSTALL_LOCAL_ONLY)
  file(WRITE "/volumes/BIGCODE/hydra_sdk/build_wasm/hydra_address/install_local_manifest.txt"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
endif()
...
if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  file(WRITE "/volumes/BIGCODE/hydra_sdk/build_wasm/hydra_address/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
endif()
